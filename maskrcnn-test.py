...
dataset_train.load_data('/mnt/ssd_4tb_0/huzaifa/oatmeal/braintumor_sampleset/train/_annotations.coco.json', '/mnt/ssd_4tb_0/huzaifa/oatmeal/braintumor_sampleset/train')
dataset_train.prepare()

#In this example, I do not have annotations for my validation data, so I am loading train data
dataset_val = CocoLikeDataset()
dataset_val.load_data('/mnt/ssd_4tb_0/huzaifa/oatmeal/braintumor_sampleset/valid/_annotations.coco.json', '/mnt/ssd_4tb_0/huzaifa/oatmeal/braintumor_sampleset/valid')
dataset_val.prepare()
...
ROOT_DIR = '/home/huzaifa/workspace/oatmeal-outputs'
# Import Mask RCNN
...
# load model weights
model.load_weights('logs/mask_rcnn_braintumor_cfg_0001.h5', by_name=True)
